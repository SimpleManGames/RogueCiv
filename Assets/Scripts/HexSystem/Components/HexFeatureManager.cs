...
public class HexFeatureManager : MonoBehaviour
{
    ...
    public void AddFeature(HexObject hex, Vector3 position)
    {
        ...
        Transform prefab = PickPrefab(urbanCollections, hex.UrbanLevel, hash.a, hash.d);

        Transform otherPrefab = PickPrefab(farmCollections, hex.FarmLevel, hash.b, hash.d);
        ...
        otherPrefab = PickPrefab(plantCollections, hex.PlantLevel, hash.c, hash.d);
